...
#define ZAXIS_STEPS_PER_MM 98.425196 //jss 2560
#endif
...
#define EXT0_STEPS_PER_MM 150 //jss 413 //385
...
#define EXT0_INVERSE false //jss true
...
// for skeinforge 40 and later, steps to pull the plasic 1 mm inside the extruder, not out.  Overridden if EEPROM activated.
#define EXT1_STEPS_PER_MM 150  //jss  373
// What type of sensor is used?
// 0 is no thermistor/temperature control
// 1 is 100k thermistor (Epcos B57560G0107F000 - RepRap-Fab.org and many other)
// 2 is 200k thermistor
...
#define HAVE_HEATED_BED 1	//jss	1
...
#define ENDSTOP_PULLUP_Z_MAX true //jss false

//set to true to invert the logic of the endstops
#define ENDSTOP_X_MIN_INVERTING false   //jss   true
#define ENDSTOP_Y_MIN_INVERTING false   //jss   true
#define ENDSTOP_Z_MIN_INVERTING false   //jss   true
#define ENDSTOP_X_MAX_INVERTING false
#define ENDSTOP_Y_MAX_INVERTING false
#define ENDSTOP_Z_MAX_INVERTING false   //jss   true

// Set the values true where you have a hardware endstop. The Pin number is taken from pins.h.

#define MIN_HARDWARE_ENDSTOP_X false	//jss	true
#define MIN_HARDWARE_ENDSTOP_Y false	//jss	true
#define MIN_HARDWARE_ENDSTOP_Z true
#define MAX_HARDWARE_ENDSTOP_X true     //jss    false
#define MAX_HARDWARE_ENDSTOP_Y true     //jss    false
#define MAX_HARDWARE_ENDSTOP_Z true     //jss    true
...
#define min_software_endstop_z true //jss false

//If true, axis won't move to coordinates greater than the defined lengths below.
#define max_software_endstop_x true
#define max_software_endstop_y true
#define max_software_endstop_z true //jss   false

// If during homing the endstop is reached, ho many mm should the printer move back for the second try
#define ENDSTOP_X_BACK_MOVE 5
#define ENDSTOP_Y_BACK_MOVE 5
#define ENDSTOP_Z_BACK_MOVE 5   //jss   2
...
#define ENDSTOP_Z_BACK_ON_HOME 1    //jss   5
...
#define X_MAX_LENGTH 200    //jss   165
#define Y_MAX_LENGTH 200    //jss   175
#define Z_MAX_LENGTH 200    //jss   116.820
...
*/
#define DELTA_DIAGONAL_ROD 214  //jss   345 // mm
...
*/
#define END_EFFECTOR_HORIZONTAL_OFFSET 23   //jss   0

/** \brief Horizontal offset of the universal joints on the vertical carriages.
*/
#define CARRIAGE_HORIZONTAL_OFFSET 25   //jss   0
...
*/
#define PRINTER_RADIUS 155  //jss   124
...
#define DELTA_DIAGONAL_ROD 214  //jss  240
#endif
...
/** \brief X, Y, Z max acceleration in mm/s^2 for printing moves or retracts. Make sure your printer can go that high!
 Overridden if EEPROM activated.
*/
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_X 1500 //jss 1000
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_Y 1500 //jss 1000
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_Z 1500 //jss 100

/** \brief X, Y, Z max acceleration in mm/s^2 for travel moves.  Overridden if EEPROM activated.*/
#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_X 3000//jss 2000
#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_Y 3000//jss 2000
#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_Z 3000 //jss 100
...
#define Z_PROBE_PIN ORIG_Z_MIN_PIN //jss 63
...
#define Z_PROBE_WAIT_BEFORE_TEST 0 //jss 1
...
*/
#define FEATURE_AUTOLEVEL 1     //jss   0
#define Z_PROBE_X1 -69.28 //jss 100
#define Z_PROBE_Y1 -40 // jss 20
#define Z_PROBE_X2 69.28 //jss 160
#define Z_PROBE_Y2 -40 //jss 170
#define Z_PROBE_X3 0 //jss 20
...
*/
#define FEATURE_SOFTWARE_LEVELING 1     //jss   0
...
#define SDSUPPORT true  //jss   false
...
#define FEATURE_CONTROLLER 2    //jss    NO_CONTROLLER
...
8 = Czech
*/
#define UI_LANGUAGE 0   //jss   1

// This is line 2 of the status display at startup. Change to your like.
#define UI_PRINTER_NAME "HomeMade"
#define UI_PRINTER_COMPANY "HM0709"
